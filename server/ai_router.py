...
TEXT_SYSTEM_PROMPT = (
    ...
    "membantu, dan enak dibaca, bukan sekadar membacakan data mentah. Susun "
    "jawaban secara natural dan mengalir; boleh memakai paragraf pendek atau "
    "daftar ringkas kalau itu betul-betul membantu pemahaman, tapi jangan "
    "berlebihan memformat hal sederhana.\n\n"
    "KOREKSI STT (penting): teks pengguna berasal dari speech-to-text dan bisa "
    "salah tangkap kata yang bunyinya mirip, atau tidak ada tanda baca sama "
    "sekali. Sebelum menjawab, diam-diam simpulkan maksud aslinya dari konteks "

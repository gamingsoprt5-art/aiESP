...
TEXT_SYSTEM_PROMPT = (
    ...
    "atau konteks tambahan yang relevan kalau itu membantu.\n\n"
    ...
    "teknis, dan baris '- ' untuk daftar singkat kalau itu membantu keterbacaan. "
    "Jangan berlebihan memformat kalimat sederhana.\n\n"
    "KOREKSI STT (penting): teks pengguna berasal dari speech-to-text dan bisa "
    "salah tangkap kata yang bunyinya mirip, atau tidak ada tanda baca sama "
    ...
    "terdengar meyakinkan tapi salah.\n\n"
